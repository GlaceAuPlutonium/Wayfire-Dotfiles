...
workspace_script = os.path.expanduser("~/.config/scripts/active_workspace_number.py")
style_file = os.path.expanduser("~/.config/waybar/style.css")
...
def update_specific_line(active_workspace):
    ...
    try:
        ...
        target_line = lines[152]  # Line 280 (zero-based index is 279)
